...
function Dashboard() {
  ...
  return (
    <div className={classes.root}>
      <CssBaseline />
      <AppBar style={{ background: '#3B4252' }} position="absolute" className={clsx(classes.appBar, open && classes.appBarShift)}>
            ...
            {(isDashboard) &&
              <Grid container alignContent='center' alignItems='center' justify='flex-start'>
                <div style={{margin: "auto"}}>
                  ...
                  <Typography variant="h3" component="h2" style={{color:"#3B4252", paddingBottom: 50}} align='center'> Medicine Prescriptions</Typography>
                </div>
              </Grid>
            }
            {(isDashboard) &&
