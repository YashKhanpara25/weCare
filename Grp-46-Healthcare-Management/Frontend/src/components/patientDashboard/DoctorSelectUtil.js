...
export default function DoctorSelectUtil({name,email,id}) {
  ...
  return (
    <Card className={classes.root} variant="elevated" key = {id} style={{display: "flex", flexDirection: "column", alignItems: "center", padding: "10px 0px"}}>
      <CardContent>
      ...
      <CardActions>
        <Button
            variant="contained"
            onClick = {setDefault}
            style={{ background: '#4C566A', color: "#fdfdfd" }}
        >
            Select as Default
        </Button>
      </CardActions>
